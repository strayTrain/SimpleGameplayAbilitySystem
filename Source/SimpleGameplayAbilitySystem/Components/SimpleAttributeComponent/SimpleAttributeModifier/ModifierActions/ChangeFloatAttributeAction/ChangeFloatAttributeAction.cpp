...
// bool UChangeFloatAttributeAction::CanApply_Implementation(USimpleAttributeModifier* NewOwningModifier) const
// {
...
// 	}
//
// 	return OwningModifier->TargetAttributeComponent->SetFloatAttributeValue(ModifiedAttributeValueType, FloatAttribute->AttributeTag, NewAttributeValue, GetScratchPad().ScratchpadValues[FDefaultTags::ScratchPadFloatOverflow()]);
// }
//
