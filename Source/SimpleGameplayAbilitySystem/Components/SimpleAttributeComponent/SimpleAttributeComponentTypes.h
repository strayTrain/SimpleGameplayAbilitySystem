...
// Tags
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnGameplayTagAddedSignature, FGameplayTag, Tag);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnGameplayTagRemovedSignature, FGameplayTag, Tag);

// Float Attributes
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnFloatAttributeAddedSignature, FGameplayTag, AttributeTag, FFloatAttribute, FloatAttribute);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnFloatAttributeRemovedSignature, FGameplayTag, AttributeTag);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnFloatAttributeLimitReachedSignature, FGameplayTag, AttributeTag, float, Overflow);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnFloatAttributeValueChangedSignature, FGameplayTag, AttributeTag, float, OldValue, float, NewValue);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnFloatAttributeBoolChangedSignature, FGameplayTag, AttributeTag, bool, OldValue, bool, NewValue);

// Struct Attributes
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnStructAttributeAddedSignature, FGameplayTag, AttributeTag, FStructAttribute, StructAttribute);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnStructAttributeRemovedSignature, FGameplayTag, AttributeTag);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FOnStructAttributeChangedSignature, FGameplayTag, AttributeTag, FInstancedStruct, OldValue, FInstancedStruct, NewValue, FGameplayTagContainer, ModificationTags);