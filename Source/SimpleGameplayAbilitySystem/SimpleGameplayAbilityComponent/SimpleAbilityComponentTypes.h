...
/* Event Dispatchers */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnFloatAttributeAddedSignature, FGameplayTag, Tag, FInstancedStruct, Payload);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnFloatAttributeChangedSignature, FGameplayTag, Tag, FInstancedStruct, Payload);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnFloatAttributeRemovedSignature, FGameplayTag, Tag, FInstancedStruct, Payload);
