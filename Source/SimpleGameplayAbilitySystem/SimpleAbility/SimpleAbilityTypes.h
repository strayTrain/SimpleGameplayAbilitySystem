...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FAbilityActivationDelegate, USimpleAbilityBase*, AbilityInstance);

// Called by an ability instance when the ability ends (either normally or canceled)
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FAbilityStoppedDelegate, USimpleAbilityBase*, AbilityInstance, FGameplayTag, StopStatus, FInstancedStruct, StopContext);
